package com.buzzware.apnigaridriver.activities.home;
...
import com.buzzware.apnigaridriver.databinding.ActivityHomeBinding;
...
public class Home extends Activity implements OnMapReadyCallback {
    ...
    private void setListener() {
        ...
        mBinding.backIV.setOnClickListener(v->{
            finish();
        });
    }
